...
echo "Loading module"
echo "sudo insmod '$KERNMOD'.ko \$1 (\$1 default value is Embedded Book Club)"
sudo insmod $KERNMOD.ko $1
echo "--------------------------------------------------------------------"
